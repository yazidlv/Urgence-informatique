...
<html>
	<head>
        ...
        <script type="text/javascript">
		    ...
		    // faire en sorte que lorsque l'on change le texte du champ de recherche, on affiche la boîte de suggestions
		     $('[name="query1"]').keyup(function(event){
				...
				$('#querySuggestions').on('click', 'li', function(){
					$('[name="query1"]').attr('value', $(this).text());
					hideSuggestionsBox();
				});
			});
	...
	<body>
		...
		<form id="queryForm" action="resultat.php" method="get">
			<input type="text" name="query1" maxlength="37">
...
$role= $user->getRole();	*/
 ...
 //affiche le menu pour le personnel
   echo'<ul><a class ="info" style="target-name:new; target-new:tab;" target="_new" href="add_staff.php"><img src="image/add.png"/><span>ajouter une personne</span></a>
<a class="info" style="target-name:new; target-new:tab;" target="_new" href="view_staff.php"><img src="image/view.png"/><span>visualiser la liste du personnel</span></a></ul><br><br>';
