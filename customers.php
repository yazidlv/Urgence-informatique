...
<html>
	<head>
        ...
        <script type="text/javascript">
		    ...
		    // faire en sorte que lorsque l'on change le texte du champ de recherche, on affiche la boîte de suggestions
		     $('[name="query2"]').keyup(function(event){
				...
				$('#querySuggestions').on('click', 'li', function(){
					$('[name="query2"]').attr('value', $(this).text());
					hideSuggestionsBox();
				});
			});
	...
	<body>
		...
		<form id="queryForm" action="resultat.php" method="get">
			<input type="text" name="query2" maxlength="37">
...
$role= $user->getRole();	*/
   ...
   echo'<ul><a class ="info" style="target-name:new; target-new:tab;" target="_new" href="add_user.php"><img src="image/add.png"/><span>ajouter un client</span></a>
<a class="info" style="target-name:new; target-new:tab;" target="_new" href="view_user.php"><img src="image/view.png"/><span>visualiser la liste des clients</span></a></ul><br><br>';
