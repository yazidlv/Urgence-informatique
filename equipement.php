...
<html>
	<head>
        ...
        <script type="text/javascript">
		    ...
		    // faire en sorte que lorsque l'on change le texte du champ de recherche, on affiche la boîte de suggestions
		     $('[name="query4"]').keyup(function(event){
				...
				$('#querySuggestions').on('click', 'li', function(){
					$('[name="query4"]').attr('value', $(this).text());
					hideSuggestionsBox();
				});
			});
	...
	<body>
		<h1>gestion du matériels</h1>
		


		<form id="queryForm" action="resultat.php" method="get">
			<input type="text" name="query4" maxlength="37">
...
$role= $user->getRole();	*/
   ...
   echo'<ul><a class ="info" style="target-name:new; target-new:tab;" target="_new" href="add_equipement.php"><img src="image/add_equi.png"/><span>ajouter un matériel</span></a>
<a class="info" style="target-name:new; target-new:tab;" target="_new" href="view_equipement.php"><img src="image/view.png"/><span>visualiser la liste du matériels</span></a></ul><br><br>';
